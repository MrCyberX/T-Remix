...
tput cup 6 30
echo -e "\x1b[42m Hacker Boss by Mr_Cyber-X \x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m Have you subscribe my channel Hacker Boss by Mr_Cyber-X (y/n)? \e[m "
read answer

if [ "$answer" != "${answer#[Yy]}" ] ;then
tput cup 17 21
    echo -e "\e[42m Thankyou for subscribe my channel for hacking tutorials \e[m"
else
tput cup 17 23
    echo -e "\x1b[41m Please subsrcibe my channel \x1b[m"
fi
tput cup 20 0
figlet -f slant "Hacker Boss by Mr_Cyber-X" |lolcat
echo " "
echo " "
